    ...
    def get_point_panorama(self, start_date, end_date, target_matricula=None):
        ...
        for func_base in funcionarios:
            ...
            while current_sim_iter <= sim_end_dt:
                ...
                # Chama a função get_expected_daily_minutes que foi corrigida
                expected_minutes = self.get_expected_daily_minutes(data_str, is_fichado)
            ...
            while current_date_iter <= end_dt:
                ...
                if dados_do_dia:
                    ...
                    total_desconto_penalidade_str = total_desconto_penalidade_str_temp # Renomeado para clareza
                ...
                ponto_dict = {
                    ...
                    'E1': '', 'S1': '', 'E2': '', 'S2': '',
                    'Carga_Horaria': carga_horaria_dia_str, # Tempo líquido
